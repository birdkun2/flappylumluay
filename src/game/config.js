export const STATE = Object.freeze({ BOOT: 'BOOT', TITLE: 'TITLE', MODE_SELECT: 'MODE_SELECT', ROGUELITE_PREVIEW: 'ROGUELITE_PREVIEW', READY: 'READY', PLAYING: 'PLAYING', GAME_OVER: 'GAME_OVER' });
